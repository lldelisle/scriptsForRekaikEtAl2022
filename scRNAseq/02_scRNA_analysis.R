...
# These plots will be used for Figure S3B
...
ggsave(filename = file.path(github.directory, "scRNAseq", "plots", "FigS3C.pdf"), width = 36, height = 16)

# Evaluate the proportion of cells with Cdx1 or Cdx2:
prop.table(table(GetAssayData(object = combined, assay = "RNA", slot = "counts")["Cdx2",] == 0 & GetAssayData(object = combined, assay = "RNA", slot = "counts")["Cdx1",] == 0, combined$Time), 2)
