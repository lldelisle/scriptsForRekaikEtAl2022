...
figures <- list("FigS6A" = list("vp" = paste0("CBS", 6:1),
                ...
                "FigS9A-1" = list("vp" = paste0("CBS", c(5, 4, 2, 1)),
                                  "time" = 96,
                                  "genotype" = "wt",
                                  "x" = "vp",
                                  "color" = "genotype",
                                  ...
                                  "group" = "vp",
                                  "title" = "CBS-CS38-40"),
                "FigS9A-2" = list("vp" = paste0("CBS", c(5, 4, 2, 1)),
                                  "time" = 96,
                                  "genotype" = "Del(d1-d4)",
                                  "x" = "vp",
                                  "color" = "genotype",
                                  ...
                                  "group" = "vp",
                                  "title" = "CBS-CS38-40"),
                "FigS9B" = list("vp" = paste0("d", c(13, 11, 9, 8)),
                                "time" = 96,
                                ...
                                "ref" = "wt",
                                "title" = "CBS-CS38-40"),
                "FigS10B" = list("vp" = paste0("d", c(13, 11, 9)),
                                 "time" = 96,
                                 ...
                                 "ref" = "wt",
                                 "title" = "CBS-CS38-40"),
                "FigS11C" = list("vp" = paste0("d", c(13, 11, 9)),
                                 "time" = 96,
                                 "genotype" = c("wt", "Del(CBS1-5)"),
                                 "x" = "vp",
                                 "color" = "genotype",
